...
cmake.exe -G"MinGW Makefiles" -DSDL_ROOT="D:/Code Projects/cpp-libraries/SDL-v2.0.22-x86_64-posix-seh-rev0-8.1.0/lib/cmake/SDL2" -DCMAKE_BUILD_TYPE=Debug -B./build &&^
cd build &&^
cmake --build . &&^
